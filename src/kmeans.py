...
def create_labels(data_frame):
    db_model = KMeans(n_clusters = 6, random_state=0, n_init="auto").fit(data_frame)
...
image_file_path = "../assets/images/kmeans_scatter.png"
...
output.to_csv("../assets/data/processed/kmeans.csv", index=False)
